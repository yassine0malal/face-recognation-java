...
//     @FXML
//     private VBox addEntryForm;
//     @FXML
//     private VBox mainTableView;
//     @FXML
//     private VBox tableRowsContainer;
//     @FXML
//     private AddPersonnelController addEntryFormController;

//     // Éléments FXML de la pagination branchés sur vos IDs
//     @FXML
//     private Label footerPaginationLabel;
//     @FXML
...
//     // Variables de pagination internes
...
//     private int itemsPerPage = 5; // Adjust based on your table setup
...
//         // 1. Demander le nombre total réel à la base de données (filtré si nécessaire)
...
//         // 2. Calculer le nombre de pages nécessaires
...
//         // 3. Calcul du décalage (Offset) pour SQLite
//         int offset = (currentPage - 1) * ITEMS_PER_PAGE;

//         // 4. Charger la liste ciblée
...
//         // 5. Générer les lignes à l'écran
...
//         // 6. Actualiser le texte et l'état du footer
//         updatePaginationUI();
//     }
...
//         // Utilise directement la page 1 avec le filtre courant
//         goToPage(1);
//     }
...
//         // 1. Clear existing buttons (keep prev/next)
//         paginationContainer.getChildren().clear();
//         paginationContainer.getChildren().add(btnPrevPage);
...
//         // Mise à jour des champs de classe pour cohérence
...
//         if (r.contains("admin") || r.contains("critical") || r.contains("5"))
//             return "badge-purple";
//         if (r.contains("senior") || r.contains("4") || r.contains("executive"))
//             return "badge-blue";
